define(function (require, exports, module) {
    exports.initModule = function (app) {
        ...
        app.message=function(msg,type){
            var maxTop=$(document).scrollTop();
            var height=0;
            for(var k in messages){
                if (messages.hasOwnProperty(k)){
                    var msgElm = $('#'+k);
                    if (msgElm){
                        var cssTop = msgElm.css("top");
                        var top=cssTop?parseInt(cssTop.replace("px","")):0;
                        if (top>maxTop) {
                            maxTop=top;
    ...
    function cell(){
        return {
            ...
            template:'<div><span ng-bind="model"></span>'+
                        ...
                        '    class="cell-error pull-right icon-exclamation-sign"'+
                        '    data-content="{{error}}"'+
    ...
    function Numeric() {}
    Numeric.prototype=new AbstractField('number',false);
    function NumericInline() {}
    NumericInline.prototype=new AbstractField('number',true);
        ...
        return (inline?"<div class='inline-block'>":'<div ng-class="{\'control-group\':true,error:error}">') +
                ...
                (inline?'':'<div class="controls">') +
                    '<select class="{{width}}" id="{{fieldId}}" '+
                        ...
                        'ng-model="model" ng-change="change()">'+
                    '</select>'+
                    (inline?
                        '<i ng-class="{hidden:!error}"'+
                            '    class="cell-error pull-right icon-exclamation-sign"'+
                            '    data-content="Valore non valido"'+
                            '    data-original-title="Errore nei dati"'+
                            '    data-toggle="popover"'+
                            '    data-trigger="hover"'+
                            '    data-placement="top">'+
